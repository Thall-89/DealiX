...
export interface Database {
  public: {
    Tables: {
      ...
      profiles: { Row: { id: string; user_id: string | null; display_name: string | null; preferred_currency: string; timezone: string; created_at: string | null; updated_at: string }; Insert: { id: string; user_id?: string | null; display_name?: string | null; preferred_currency?: string; timezone?: string }; Update: { display_name?: string | null; preferred_currency?: string; timezone?: string }; Relationships: [] };
