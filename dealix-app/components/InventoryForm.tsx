...
function blankPart(): InventoryItem {
  ...
  return { id, slug: id, name: "", category: "GPU", brandModel: "", purchaseCost: 0, condition: "Good", testingStatus: "Needs Testing", currentStatus: "Available", storageLocation: "", notes: "" };
}
